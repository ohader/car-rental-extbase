<?php
namespace OliverHader\CarRentalB\Service\Import;
...
{
    const TABLE_NAME_BRAND = 'tx_carrentalb_domain_model_brand';
    const TABLE_NAME_CAR = 'tx_carrentalb_domain_model_car';
    const TABLE_NAME_TIRE = 'tx_carrentalb_domain_model_tire';
