...
use OliverHader\CarRentalB\Domain\Repository\RentalRepository;
use OliverHader\CarRentalB\Service\Customer\InvalidSessionException;
use OliverHader\CarRentalB\Service\Customer\SessionService;
...
class RentalController extends ActionController
{
     ...
     * @param Car $car
     * @param Rental $rental
     * @validate $rental \OliverHader\CarRentalB\Validation\Rental\DatesValidator
     */
