...
{
    /**
     * @var \OliverHader\CarRentalB\Domain\Model\Rental
     */
    protected $subject = null;

    protected function setUp()
    {
        $this->subject = new \OliverHader\CarRentalB\Domain\Model\Rental();
    }
    ...
    {
        $customerFixture = new \OliverHader\CarRentalB\Domain\Model\Customer();
