<?php
namespace OliverHader\CarRentalB\Tests\Functional\Services\Import;

use OliverHader\CarRentalB\Service\Import\ExtbaseService;
...
class ExtbaseServiceTest extends FunctionalTestCase
{
    ...
    public function csvDataCanBeImported()
    {
        ...
        $cars = $this->getAllRecords('tx_carrentalb_domain_model_car');
        $brands = $this->getAllRecords('tx_carrentalb_domain_model_brand');
        $tires = $this->getAllRecords('tx_carrentalb_domain_model_tire');
